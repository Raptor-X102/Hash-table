...
size_t Hash_func_stack_version(const void * buffer_start, const void * buffer_end);
...
bool Hash_table_plot_hist(Hash_table_t* hash_table, const char* output_file_name);

typedef int64_t (*Find_func_t) (Hash_table_t* hash_table, void* element, int element_size, Compare_func_t compare_func);
